export const defaultStyle = {
  ...
  sources: {
    composite: {
      ...
      data: {
        ...
        maxzoom: 16,
        minzoom: 0,
        name: "Mapbox Bathymetry v2 + Mapbox Terrain v2 + Mapbox Streets v8",
        scheme: "xyz",
        tilejson: "3.0.0",
        tiles: [
          "mapbox://tiles/mapbox.mapbox-streets-v8,mapbox.mapbox-terrain-v2,mapbox.mapbox-bathymetry-v2/{z}/{x}/{y}.vector.pbf",
        ],
        vector_layers: [
          {
            id: "landuse",
  ...
  sprite:
    "mapbox://sprites/vubpazqwkd/cmcp5nc8c008z01r56miqbyz7/6iqitl5z21pbbxxwuij8b59i2",
  ...
  layers: [
    ...
    },
    {
      ...
      filter: [
        "all",
        ["match", ["get", "class"], ["military", "civil"], true, false],
        [
          "step",
          ["pitch"],
          true,
  ...
  created: "2025-07-04T18:35:39.564Z",
  modified: "2025-07-05T06:50:29.454Z",
  id: "cmcp5nc8c008z01r56miqbyz7",
  owner: "vubpazqwkd",
  visibility: "private",
  protected: false,
  draft: false,
